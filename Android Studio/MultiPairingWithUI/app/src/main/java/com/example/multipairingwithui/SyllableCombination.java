...
public class SyllableCombination {
    ...
    SyllableCombination() throws HangulParserException {
    ...
    public String getSentence(ArrayList<String> arr) throws HangulParserException {
        this.arr = arr;
        ...
        return HangulParser.assemble(arr);
    }
